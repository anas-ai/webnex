...
function PortfolioCard({ portfolio: { title, description, img , link, category} }) {
	return (
		<div className="aximo-project-thumb">
			<Image src={img} alt={title} sizes="100vw"  className={category === "app" ? "app-img" : "web-img"}/>
			<div className="aximo-project-wrap">
				...
				<Link className="aximo-project-icon" href={link} target="_blank">
